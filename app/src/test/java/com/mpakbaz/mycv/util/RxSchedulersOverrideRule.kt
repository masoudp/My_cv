...
class RxSchedulersOverrideRule : TestRule {
    ...
    private val mSchedulerFunction = Function<Scheduler, Scheduler> { schedulerInstance }
    private val mSchedulerFunctionLazy = Function<Callable<Scheduler>, Scheduler> { schedulerInstance }
